...
def make_datasets(cfg: DictConfig):
    ...
    return fetch_dataset(
        ...
        filter_frames=data_cfg["filter_frames"],
        filter_groups=data_cfg["filter_groups"],
        filter_in_channels=data_cfg["filter_in_channels"],
        conditioning_in_channels=data_cfg["conditioning_in_channels"],
        include_conditioning_parameters=data_cfg["include_conditioning_parameters"],
        filter_out_channels=data_cfg["filter_out_channels"],
