    ...
    def forward(
        ...
        if isinstance(self.weight_schedule, WeightSchedule) and self.weight_schedule.is_scalar_only():
            ...
            if sq_error.ndim >= 2:
                ...
                denom_t = sq_u.mean(dim=dims_to_reduce)
            ...
            if sq_error.ndim >= 3:
                ...
                denom_c = sq_u.mean(dim=dims_to_reduce)
        ...
        # Compute denominator: <|u|^2> with same weighting
        sq_u = labels ** 2
        weighted_sq_u = sq_u * weight_tensor
        denom = weighted_sq_u.mean()
        ...
        weighted_sq_u_for_detailed = weighted_sq_u if preserve_component_grads else weighted_sq_u.detach()
        ...
        if labels.ndim >= 2:
            ...
            denom_t = weighted_sq_u_for_detailed.mean(dim=dims_to_reduce)
        ...
        if labels.ndim >= 3:
            ...
            denom_c = weighted_sq_u_for_detailed.mean(dim=dims_to_reduce)
